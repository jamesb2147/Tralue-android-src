 ...
 */
public class InkClassicBusiness extends Card {
    public InkClassicBusiness() {
        /*
        ...
        */
        ...
        this.setChip("No");
        this.setNotes("See the Ink Cash for the cash-earning version of this card. Earn 5 points per dollar on the first $25,000 spent " +
        		"annually at office supply stores and on cellular phone, landline, internet and cable TV service, 2 points per $1 on the " +
        		"first $25,000 spent annually at gas stations and for hotel accommodations when purchased directly with the hotel.");
        this.setUrl("http://thepointsguy.com/go/InkClassicTD/");
