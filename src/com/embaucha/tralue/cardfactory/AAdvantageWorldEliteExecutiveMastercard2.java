 ...
 */
public class AAdvantageWorldEliteExecutiveMastercard2 extends Card {
    public AAdvantageWorldEliteExecutiveMastercard2() {
        /*
        ...
        */
        ...
        this.setSpend_bonus(75000);
        this.setSpend_requirement(7500);
        ...
        this.setNotes("With this card you will receive your first checked bag free, Admirals Club membership privileges, " +
				"25% off in-flight purchases, and 10,000 elite qualifying miles after $40,000 in spend in one year.");
        this.setUrl("https://www.citicards.com/cards/acq/Apply.do?app=UNSOL&sc=4XEIW594&m=1QAEA11111W&langId=EN&siteId=CB&B=A&screenID=3001");
