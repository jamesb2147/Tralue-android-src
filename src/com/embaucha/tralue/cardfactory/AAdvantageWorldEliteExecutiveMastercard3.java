 ...
 */
public class AAdvantageWorldEliteExecutiveMastercard3 extends Card {
    public AAdvantageWorldEliteExecutiveMastercard3() {
        /*
        ...
        */
        ...
        this.setSpend_bonus(100000);
        this.setSpend_requirement(10000);
        ...
        this.setNotes("With this card you will receive your first checked bag free, Admirals Club membership privileges, " +
				"25% off in-flight purchases, and 10,000 elite qualifying miles after $40,000 in spend in one year.");
        this.setUrl("https://creditcards.citicards.com/usc/Travel/AA/2013/q3/Exec/GA/default.htm?BT_TX=1&ProspectID=8289431BF5BC49478648B92A43DF07A8");
