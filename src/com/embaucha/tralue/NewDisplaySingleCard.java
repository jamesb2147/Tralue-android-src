...
//		TestFlight.log("After setting view...");
		...
		setEverythingInvisible(); //does not include progress bar
...
//		TestFlight.log("Destination is: " + destination);
		...
		((TextView)findViewById(R.id.card_carrier)).setText(award.getString("point_program"));
		//miles provided by card bonuses
		((TextView)findViewById(R.id.miles_from_card)).setText(Integer.toString(calculateBonusPoints(card, partner)));
		//percentage of needed miles earned by signup
...
//		((TextView)findViewById(R.id.card_foreign_transaction_fee_text)).setVisibility(View.GONE);
//		((TextView)findViewById(R.id.card_foreign_transaction_fee_text)).setVisibility(View.GONE);
//		((TextView)findViewById(R.id.card_foreign_transaction_fee_text)).setVisibility(View.GONE);
//		((TextView)findViewById(R.id.card_foreign_transaction_fee_text)).setVisibility(View.GONE);
//		((TextView)findViewById(R.id.card_foreign_transaction_fee_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_issuer_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.percent_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_origin_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_destination_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_cost_in_miles_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_carrier_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.miles_from_card_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_percentage_of_miles_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_annual_fee_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_foreign_transaction_fee_text)).setVisibility(View.GONE);
		((Button)findViewById(R.id.apply_now_button)).setVisibility(View.GONE);
		((Button)findViewById(R.id.email_to_self_button)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.points_program_notes_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.award_notes_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.card_notes_text)).setVisibility(View.GONE);
		((TextView)findViewById(R.id.award_disclaimer_text)).setVisibility(View.GONE);
	}
	
	protected void setEverythingVisible() {
		((TextView)findViewById(R.id.card_issuer_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.percent_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_origin_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_destination_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_cost_in_miles_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_carrier_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.miles_from_card_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_percentage_of_miles_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_annual_fee_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_foreign_transaction_fee_text)).setVisibility(View.VISIBLE);
		((Button)findViewById(R.id.apply_now_button)).setVisibility(View.VISIBLE);
		((Button)findViewById(R.id.email_to_self_button)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.points_program_notes_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.award_notes_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.card_notes_text)).setVisibility(View.VISIBLE);
		((TextView)findViewById(R.id.award_disclaimer_text)).setVisibility(View.VISIBLE);
	}
